...
import { NeuesProjektDialogComponent } from './views/.formulare/neues-projekt/neues-projekt-dialog/neues-projekt-dialog.component';
import { ActionButtonComponent } from './views/view-menu/action-button/action-button.component';
import { AuftragAnlegenDialogComponent } from './views/.formulare/auftrag-anlegen/auftrag-anlegen-dialog/auftrag-anlegen-dialog.component';
