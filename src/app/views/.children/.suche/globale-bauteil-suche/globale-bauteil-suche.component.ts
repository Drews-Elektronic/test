    ...
    switch(this.methode){
      ...
      case Methoden.BAUTEIL_SUCHEN:
        let subscription_AlternativeAngebenImport = this.backend
          .AlternativeAngebenImport( btbeschreibung, htnr, btnrli, linr, this.gesamtmenge ).subscribe((value) => {
      ...
      case Methoden.BAUGRUPPE:
        let subscription_AlternativeAngebenBaugruppe = this.backend
          .AlternativeAngebenBaugruppe( this.btnr, this.bgnr, this.gesamtmenge, htnr, btnrli, btbeschreibung, linr ).subscribe((value) => {
      ...
      case Methoden.BAUTEILE:
        let subscription_AlternativeAngebenBauteil = this.backend
          .AlternativeAngebenBauteil( this.btnr, this.bgnr, this.gesamtmenge, htnr, btnrli, btbeschreibung, linr ).subscribe((value) => {
      ...
      break;
      case Methoden.ANGEBOT:
        let subscription_AlternativeAngebenAngebot = this.backend
          .AlternativeAngebenAngebot( this.btnr, this.aunr, this.gesamtmenge, htnr, btnrli, btbeschreibung, linr ).subscribe((value) => {
            subscription_AlternativeAngebenAngebot.unsubscribe();
            this.loading_such_ergebnis = false;
            this.lade_status.emit(false);
