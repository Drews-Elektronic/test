...
export class ImportBauteileTabelleComponent {
    ...
    umleiten_nach_import_anlegen(){ // wurde ersetzt durch 'dialog_import_anlegen()'
        if(this.neues_projekt){
            this.router.navigate(UtilUrl.neuesProjekt.import_anlegen)
        }else{
            this.router.navigate(UtilUrl.import.anlegen)
        }
    }
