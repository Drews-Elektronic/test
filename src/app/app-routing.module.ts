...
import { Keycloak_AuthGuard } from './guard/keycloak.auth.guard';
...
const getChildrenRoute = (url_array: any[]) => {
  let result = "";
  if (url_array) {
    if (url_array.length === 1) {
      result = url_array[0];
      ...
      let tmp_result = url_array.slice(1);
      // Erstelle ein String aus dem Array
...
const routes: Routes = [
   ...
   ************************************************* */
  // Neues Projekt
  { path: getRoute(UtilUrl.neuesProjekt.neues_projekt), component: NeuesProjektAnlegenComponent, canActivate: [AuthGuard] },
  ...
  { path: getRoute(UtilUrl.neuesAngebot.neues_angebot_baugruppen), component: NeuerAuftragAnlegenComponent, canActivate: [AuthGuard] }, // Wenn in /auftraege ein neuer Auftrag erstellt werden soll // wird nicht mehr benötigt
  { path: getRoute(UtilUrl.neuesAngebot.neues_angebot(':bgnr')), component: NeuerAuftragAnlegenComponent, canActivate: [AuthGuard] }, // Wenn in /baugruppen ein neuer Auftrag erstellt werden soll
  ...
  { path: getRoute(UtilUrl.neuesAngebot.alternativ(':bgnr', ':id')), component: AlternativesBauteilSuchenComponent, canActivate: [AuthGuard] },
  ...
  { path: getRoute(UtilUrl.angebote.alternativ(':bgnr', ':aunr', ':id')), component: AlternativesBauteilSuchenComponent, canActivate: [AuthGuard] },
  ...
  { path: getRoute(UtilUrl.bestellungen.bom(':bestellungID')), component: BestellungenBomComponent, canActivate: [AuthGuard] },
