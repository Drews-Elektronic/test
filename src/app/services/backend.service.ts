...
export class BackendService {
    ...
    SucheMitSkuUndMpnAlternativeAngebot(aunr: any, id: any, baugruppenmenge: any){
        console.log(baugruppenmenge)


        let form: FormData = new FormData();

        form.append('viewaction', 'alternative:suchenangebot');
        form.append('kdnr', this.kundennummer as unknown as string);
        
        form.append('id', id as unknown as string);
        form.append('aunr', aunr as unknown as string);
        form.append('baugruppenmenge', baugruppenmenge as unknown as string);
    ...
    AlternativesAngebotSpeichern(aunr: any, id: any, bqnr: any, baugruppenmenge: any){
        let form: FormData = new FormData();

        form.append('viewaction', 'alternative:speichernangebot');
        form.append('kdnr', this.kundennummer as unknown as string);
        
        form.append('aunr', aunr as unknown as string ?? 0);
        form.append('id', id as unknown as string ?? 0);
        form.append('bqnr', bqnr as unknown as string ?? 0);
        form.append('baugruppenmenge', baugruppenmenge as unknown as string ?? 0);
    ...
    AlternativeAngebenAngebot(btnr: any, aunr: any, baugruppenmenge: number, htnr: any, btnrli: any, btbeschreibung: string, linr: any){
        let form: FormData = new FormData();

        form.append('viewaction',           'alternative:angebenangebot');
        form.append('kdnr',                 this.kundennummer as unknown as string);
    ...
    AusgewaehltesAlternativesAngebotLoeschen(element: any){
        let form: FormData = new FormData();

        form.append('viewaction', 'alternative:loeschenangebot');
        form.append('kdnr',       this.kundennummer as unknown as string);

        form.append('id',       element.ID            as unknown as string);
...
// Speichern der Baugruppenzeile
    ...
    UpdateAuftragStuecklistezeile(
        ...
        form.append('viewaction', 'auftragsstueckliste:aktualisieren');

        form.append('kdnr', this.kundennummer as unknown as string);

        form.append('aunr', aunr as unknown as string);
        form.append('id', id as unknown as string);
        form.append('agbskd', agbskd as unknown as string);
    ...
    //#endregion
    //#region Auftrag
    GetAuftraege(aunr: any = undefined, bestellt: boolean | null = null): Observable<Auftrag[] | false> {
        let form: FormData = new FormData();
        ...
        form.append('bestellt', bestellt as unknown as string);
    ...
    UpdateAuftraeg(auftrag: any, gespeichert: 0|1 | undefined = undefined): Observable<number | false> {
        let form: FormData = new FormData();
        ...
        if(gespeichert === null || gespeichert === undefined){
            ...
            form.append('gespeichert', gespeichert as unknown as string);
        }
    ...
    QuellenAktualisierenNew(art: string, nr: any, baugruppenmenge: any, einzelpruef: any, btnrkd:any, Mitteilung: boolean = true): Observable<true | false>{
        let form: FormData = new FormData();
         ...
         *  dann nr = slnr
         */
        form.append('nr', nr as unknown as string);
    ...
    FristPruefen(aunr: any){
        let form: FormData = new FormData();

        form.append('viewaction', 'auftraege:fristpruefen');
        form.append('kdnr', this.kundennummer as unknown as string);
